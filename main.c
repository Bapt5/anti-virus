...
int main()
{
    ...
    test_fonction("v7", "starter 1", v7, starter1, affiche_solution, pause, publisher);
    // printf("\n");
    ...
    test_fonction("v7", "junior 17", v7, junior17, affiche_solution, pause, publisher);
    // printf("\n");
    ...
    test_fonction("v7", "wizard 60", v7, wizard60, affiche_solution, pause, publisher);
    // printf("\n");
    ...
    // test_fonction("v7", "expert 33", v7, expert33, affiche_solution, pause, publisher);
    // printf("\n");
    ...
    test_fonction("v7", "wizard 52", v7, wizard52, affiche_solution, pause, publisher);
